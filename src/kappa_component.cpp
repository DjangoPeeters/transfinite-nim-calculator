...
const uint16_t kappa_component::get_k() const {
    return k;
}

const uint16_t kappa_component::get_n() const {
    return n;
}

const uint16_t kappa_component::get_exponent() const {
    return exponent;
}

const uint16_t kappa_component::get_p() const {
    return p;
}
